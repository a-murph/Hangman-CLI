...
function endGame() {
	...
	if (words.length == 0)		
		words = ["Fullmetal Alchemist Brotherhood", "Parasyte", "Ouran High School Host Club", "Princess Mononoke", "Garzeys Wing", "Wolfs Rain", "Space Dandy", "Blue Exorcist", "One Punch Man", "One Piece", "Penguindrum", "Madoka Magica", "Howls Moving Castle"];
